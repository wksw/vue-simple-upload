  ...
  methods: {
      ...
      return new Promise((resolve, reject) => {
        const handler = () => {
          ...
          if (forms.length) {
            ...
            instance
              .post('a2/multipartupload', formData, {
    ...
    mergeRequest(data) {
      ...
      return new Promise((resolve, reject) => {
        ...
        instance
          .get('a1/file/multipartupload/merge', {params: obj}, {
            timeout: 0
          })
          .then((res) => {
    ...
    // 文件上传之前的校验： 校验文件是否已存在
    verifyUpload(uploadId, chunkMd5, chunkNum) {
      return new Promise((resolve) => {
        ...
        instance
          .get('a1/file/multipartupload/isuploaded?ihc=true', { params: obj })
          .then((res) => {
